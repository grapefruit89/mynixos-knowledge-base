---
title: input-branches (mightyiam Nugget)
category: architecture/dendritic
capabilities: [modular-flakes, flake-parts-expert, infrastructure-as-code]
sources: [https://github.com/mightyiam/input-branches]
---
