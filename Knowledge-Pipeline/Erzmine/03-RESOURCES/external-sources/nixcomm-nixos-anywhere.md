---
title: nixos-anywhere (nix-community Server Nugget)
category: architecture/infrastructure
capabilities: [remote-install, secure-boot, server-profiles, identity, binary-cache]
sources: [https://github.com/nix-community/nixos-anywhere]
---
