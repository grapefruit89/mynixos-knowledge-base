...
Satellites (MANDATORY):
  ...
  → Leak-Protection (ohne aktives wg-Interface: KEIN Netzwerk-Escape)
...
{ pkgs, config, ... }:
{
  # Satellite-Check (ADR-040): Vor diesem Modul müssen alle DISK_STORAGE_*
...
### Archiv-Direktive (Ausführungsbefehl für Gemini CLI)

```bash
# AUSFÜHREN AUF DEM SERVER nach Erzeugung von v12.0:

# 1. Archiv-Verzeichnis sicherstellen
mkdir -p /home/Knowledge-Pipeline/Erzmine/02-ARCHIVE/versions/

# 2. v7.0 archivieren
cp /home/Knowledge-Pipeline/Erzmine/02-ARCHIVE/snapshots/kb-raw-backup/GEMINI.md \
   /home/Knowledge-Pipeline/Erzmine/02-ARCHIVE/versions/GEMINI_v7.0.md

# 3. v10.0 archivieren
cp /home/Knowledge-Pipeline/Almanach/GEMINI.md \
   /home/Knowledge-Pipeline/Erzmine/02-ARCHIVE/versions/GEMINI_v10.0.md

# 4. v11.0 archivieren (Werkstatt-Kopie, die durch v12.0 ersetzt wird)
cp /home/Werkstatt/GEMINI.md \
   /home/Knowledge-Pipeline/Erzmine/02-ARCHIVE/versions/GEMINI_v11.0.md

# 5. v12.0 als neue Aktive in Werkstatt platzieren
# (Wird durch diesen Schreibvorgang bereits erledigt)

# 6. Beweispflicht
ls -la /home/Knowledge-Pipeline/Erzmine/02-ARCHIVE/versions/
echo "✅ Archivierung abgeschlossen – v12.0 ist aktiv"
```
