---
title: zero-to-nix (mightyiam Nugget)
category: architecture/resources
capabilities: [best-practices, testing, learning]
sources: [https://github.com/mightyiam/zero-to-nix]
---
