...
*   **Begründung:** Home Assistant ist ein speicherintensiver Python-Dienst. Um die Stabilität der Kern-Infrastruktur (Postgres, Caddy) bei Lastspitzen zu gewährleisten, erhält Hass eine geringere OOM-Priorität.

---
**Community-Abgleich:** Konform zu `nixpkgs/nixos/modules/services/home-automation/home-assistant.nix`.
