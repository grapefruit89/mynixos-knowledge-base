---
title: The Perfect Media Server (PMS) on NixOS
category: architecture/media-infrastructure
capabilities: [zfs-storage, mergerfs-snapraid, nixos-migration]
sources: [https://github.com/ironicbadger/pms-wiki]
---

# 📚 The PMS Bible: ironicbadger's Path to NixOS

Alex Kretzschmar (@ironicbadger) hat den PMS-Standard definiert.

## 🏛️ Kern-Architektur (The NixOS Move)
- **Storage:** Übergang von MergerFS/SnapRAID zu ZFS-nativem Management in NixOS.
- **Dendritic-Ish:** Er nutzt ein modulares Flake-Setup, um seine verschiedenen "Infra-Nodes" zu steuern.
- **SSoT:** Zentrale Definition von Mount-Punkten und Freigaben.

## 🚀 Warum wichtig für mynixos?
- Alex hat exakt dieselbe Reise (Unraid/Ubuntu -> NixOS) hinter sich. Seine ADRs sind unsere Wegweiser.
