...
*   **Entscheidung:** Einführung eines automatisierten Guards, der den Realzustand im Internet mit der lokalen Wunsch-Konfiguration abgleicht.
*   **Vorteil:** Erhöhte Resilienz gegenüber externen API-Ausfällen oder DNS-Verzögerungen.

---
**Sources:**
*   `10-gateway/dns-automation.nix`
*   `10-gateway/landing-zone-ui.nix`
