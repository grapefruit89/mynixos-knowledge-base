---
title: forwardproxy (Caddy Security Nugget)
category: architecture/ingress
capabilities: [automatic-https, security-proxy, custom-builds, tls-automation]
sources: [https://github.com/caddyserver/forwardproxy]
---
