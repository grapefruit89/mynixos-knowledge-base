---
title: dotnix (Developer Experience Nugget)
category: architecture/community-config
capabilities: [home-manager, nixvim, dev-environment]
sources: [https://github.com/kiriwalawren/dotnix]
---

# 🛠️ dotnix: SRE Developer Experience

Dieses Repository zeigt, wie man eine professionelle Arbeitsumgebung direkt in NixOS integriert.

## 🚀 Warum wichtig?
- **Nixvim:** Erlaubt eine voll deklarative Neovim-Konfiguration. Perfekt, um direkt auf dem Tower (via SSH) Aviation-Grade Code-Edits vorzunehmen.
- **Home-Manager:** Saubere Trennung von User-Konfigurationen.

## 🧩 Integration (Layer 10)
Auch wenn wir einen Server bauen, brauchen wir Werkzeuge. Die Patterns aus  helfen uns, diese Werkzeuge (Git, Editoren, Shell-Tools) deklarativ zu verwalten.
<h1 align="center">
